...
- Добавлено редактирование трат:
  - кнопка “карандаш” в списке “Последние траты”
  - модалка редактирования + сохранение через `updateTransaction`
  - `ui:snap` снимает edit-модалку и делает smoke на enable кнопки
