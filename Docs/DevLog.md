...
- Добавлено редактирование категорий:
  - кнопка “карандаш” в списке категорий
  - модалка редактирования (цвет + название)
  - `ui:snap` снимает categories-edit-modal и делает smoke через `data-e2e`
